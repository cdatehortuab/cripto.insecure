	...
	<div class="row">
		<form role="form" class="form-horizontal" action="<?php echo LINK_GLOBAL; ?>index.php/register/register" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="username" class="form-control" type="text" name="username" placeholder="johndoe" required>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="birthday" class="form-control" type="date" name="birthday" placeholder="aaaa-mm-dd" required>
				</div>
			</div>
			<div class="form-group">
